    ...
    <div className="main_container">
      ...
      <section className="dataset-overview mb-12">
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-4">
          🌾 Irrigation Decision System: Dataset Overview
        </h2>
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                Name of the crop (e.g., Wheat, Rice, Maize, etc.)
              </td>
            ...
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                Type of soil (e.g., Sandy, Clay, Loamy, etc.)
              </td>
              <td className="border border-gray-300 p-2">-</td>
            </tr>
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                Maximum water that the soil can retain
              </td>
            ...
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                Number of days for the current growth phase
              </td>
            ...
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                Amount of irrigation needed per day in this phase
              </td>
            ...
            <tr>
              ...
              <td className="border border-gray-300 p-2">
                Recommended soil moisture level for healthy growth
              </td>
      ...
      <h2 className="text-2xl font-bold text-gray-800 mb-4">
        🌧️ Calculating Forecasted Rainfall
      </h2>

      <section className="rainfall-forecast mb-12 mt-8">
        <h3 className="text-xl font-bold text-gray-800 mb-2">
          <strong>1. Data Sources for Rainfall Forecast</strong>
        </h3>
        <p>
          The system fetches rainfall predictions from{" "}
          <strong>Open-Meteo API</strong> or <strong>NASA SMAP data</strong> for
          a given <strong>latitude</strong> and <strong>longitude</strong>.
        </p>
        <p>
          The API provides precipitation forecasts in{" "}
          <strong>millimeters (mm)</strong>.
        </p>

        <h3 className="text-xl font-bold text-gray-800 mb-2">
          <strong>
            2. Adjusting Forecasted Rainfall for Soil Infiltration
          </strong>
        </h3>
        <p>
          Not all forecasted rain contributes to soil moisture; some water{" "}
          <strong>runs off</strong> or <strong>evaporates</strong>.
        </p>
        <p>
          We assume a <strong>50% infiltration rate</strong>:
        </p>
        <p>
          <strong>Effective Rainfall</strong> = Forecasted Rainfall × 0.5
        </p>
        <p>
          If the API provides <strong>30 mm</strong> of forecasted rain:
        </p>
        <p>
          <strong>30 × 0.5 = 15 mm</strong> (effective rain available for soil)
        </p>

        {/* New Section for Irrigation Needs */}
        <h3 className="text-xl font-bold text-gray-800 mb-4">
          <strong>3. Determining Whether Irrigation is Needed</strong>
        </h3>
        <h4 className="text-lg font-bold text-gray-800 mb-2">
          <strong>3.1 Input Parameters Used in the Calculation</strong>
        </h4>
        <ul className="list-disc list-inside mb-4">
          <li>
            <strong>Current Soil Moisture</strong> (cm³/cm³) - Measured soil
            moisture before irrigation.
          </li>
          <li>
            <strong>Optimal Soil Moisture</strong> (cm³/cm³) - The required soil
            moisture level for the crop.
          </li>
          <li>
            <strong>Required Irrigation per Day</strong> (mm/day) - The water
            needed for healthy crop growth.
          </li>
          <li>
            <strong>Forecasted Effective Rainfall</strong> (mm) - The amount of
            rain expected to reach the soil.
          </li>
        </ul>

        {/* New Section for Irrigation Calculation Formula */}
        <h4 className="text-lg font-bold text-gray-800 mb-2">
          <strong>3.2 Irrigation Calculation Formula</strong>
        </h4>
        <p>
          To determine if irrigation is needed, we compare the{" "}
          <strong>soil moisture deficit</strong> and the{" "}
          <strong>expected effective rainfall</strong>:
        </p>

        <h5 className="font-bold mb-2">
          <strong>1. Calculate Soil Moisture Deficit</strong>
        </h5>
        <p>
          <strong>Deficit</strong> = (<strong>Optimal Soil Moisture</strong> -{" "}
          <strong>Current Soil Moisture</strong>) × 1000
        </p>
        <p>
          - This converts <strong>cm³/cm³</strong> to <strong>mm</strong> (water
          depth).
        </p>
        <p>
          - Example: If <strong>Optimal Moisture = 0.40 cm³/cm³</strong> and{" "}
          <strong>Current Moisture = 0.25 cm³/cm³</strong>:
        </p>
        <p>
        ...
        <h5 className="font-bold mb-2">
          <strong>2. Compare Deficit with Effective Rainfall</strong>
        </h5>
        <p>
          - If <strong>Effective Rainfall greater than Deficit </strong>,{" "}
          <strong>no irrigation is needed</strong>.
        </p>
        <p>
          - If <strong>Effective Rainfall less than Deficit </strong>,{" "}
          <strong>irrigation is required</strong>.
        </p>
        <p>- Example:</p>
        <ul className="list-disc list-inside mb-4">
          <li>
            <strong>Effective Rainfall = 10 mm</strong>, but{" "}
            <strong>Deficit = 150 mm</strong> →{" "}
            <strong>Irrigation needed</strong>.
          </li>
          <li>
            <strong>Effective Rainfall = 200 mm</strong>, but{" "}
            <strong>Deficit = 150 mm</strong> →{" "}
        ...
        <h5 className="font-bold mb-2">
          <strong>3. Final Irrigation Requirement Calculation</strong>
        </h5>
        <p>- If irrigation is needed, calculate the water required:</p>
        <p>
          <strong>Water Needed</strong> = <strong>Deficit</strong> -{" "}
          <strong>Effective Rainfall</strong>
        </p>
        <p>- Example:</p>
        <p>
          - Deficit = <strong>150 mm</strong>, Effective Rainfall ={" "}
          <strong>10 mm</strong>:
        </p>
        <p>
          ...
          <table className="min-w-full border-collapse border border-gray-300">
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-2">
                  <strong>Yes</strong> (200 - 10 = 190 mm required)
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="min-w-full border-collapse border border-gray-300">
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-2">
                  <strong>No</strong> (Effective Rainfall covers deficit)
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {soilData.map((soil, index) => (
            <div
              key={index}
              className="soil-card p-6 bg-white rounded-xl shadow-lg"
            >
          ...
          <tbody className="bg-white">
            {soilData.map((soil, index) => (
              ...
              >
                ...
                <td className="p-3">
                  {soil.identification.regions.slice(0, 3).join(", ")}...
                </td>
        ...
        <div className="conclusion-card mt-8 p-6 bg-blue-50 rounded-lg">
          ...
          <ul className="space-y-2">
            <li className="flex items-center">
              ...
              <strong>Red Soil:</strong> Quick-drying, needs frequent irrigation
              • Best for drought-resistant crops
            </li>
            <li className="flex items-center">
              <span className="w-2 h-2 bg-gray-800 rounded-full mr-2"></span>
              <strong>Black Soil:</strong> Self-aerating cracks • Excellent
              moisture retention • Cotton's preferred base
            </li>
            <li className="flex items-center">
              <span className="w-2 h-2 bg-yellow-600 rounded-full mr-2"></span>
              <strong>Alluvial Soil:</strong> River-deposited fertility •
              Balanced drainage • Supports multiple cropping
            </li>
          </ul>
          <div className="conclusion-card mt-8 p-6 bg-blue-50 rounded-lg">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="https://www.agricultureinindia.net/irrigation-2/crop-water-requirement/crop-water-requirement-for-different-crops-in-india/18980">
              ...
              <li className="flex items-center">
                ...
                <a href="http://ecoursesonline.iasri.res.in/Courses/Water%20Management%20including%20Micro%20Irrigation/AGRO103/Data%20Files/lec07.pdf0">
